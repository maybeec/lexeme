...
import io.github.maybee.lexeme.LeXeMeBuilder;
import io.github.maybee.lexeme.LeXeMeFactory;
import io.github.maybee.lexeme.LeXeMerger;
import io.github.maybee.lexeme.common.exception.MultipleInstancesOfUniqueElementException;
import io.github.maybee.lexeme.common.exception.XMLMergeException;
import io.github.maybee.lexeme.common.util.JDom2Util;
import io.github.maybee.lexeme.merge.element.matcher.ElementComparator;
import io.github.maybee.lexeme.merge.element.matcher.ElementComparatorBuilder;
import io.github.maybee.lexeme.merge.element.matcher.ElementComparatorFactory;
...
public class ElementMergerImplTest {
  ...
  /**
   * Test method for
   * {@link io.github.maybee.lexeme.merge.element.ElementMergerImpl#merge(Element, Element, ConflictHandlingType)}
   * <P>
  ...
  public void testMergeSimpleElementOnlyContent() throws Exception {
    ...
    // testContent.setType(ContentType.USE_FIRST);
    testConfig.setContent(testContent);
  ...
  public void testMergeSimpleElementOnlyAttributes() throws JDOMException, IOException, XMLMergeException {
    ...
    Document secondDoc =
        JDom2Util.getInstance().getDocument(this.path + "Patch/SimpleElementOnlyAttributes.xml", false);
    Handling testConfig = new Handling();
  ...
  public void testMergeSimpleElementContentAndAttributes() throws Exception {
    ...
    Document firstDoc =
        JDom2Util.getInstance().getDocument(this.path + "Base/SimpleElementContentAndAttributes.xml", false);
    Document secondDoc =
        JDom2Util.getInstance().getDocument(this.path + "Patch/SimpleElementContentAndAttributes.xml", false);
    Handling testConfig = new Handling();
    // testConfig.setType(HandlingType.FULL_ACCU);
    testConfig.setFor("A");
    ...
    Content testContent = new Content();
    testContent.setAttachable(true);
    testContent.setSeparationString("");
    testConfig.setContent(testContent);
  ...
  public void testMergeElementWithChildElement() throws Exception {
    ...
    testContent.setAttachable(true);
    testContent.setSeparationString("");
    testChildConfig.setContent(testContent);
  ...
  public void testMergeElementWithChildElements() throws Exception {
    ...
    testContent.setAttachable(true);
    testContent.setSeparationString("");
    testFirstChildConfig.setContent(testContent);
  ...
  public void testNewNonRootNamespace() throws Exception {
    ...
    when(provider.getCriterionFor(Matchers.anyString(), Matchers.anyString())).thenReturn(new LinkedList<Criterion>());
  ...
  MergeSchema loadMergeSchema(String path) throws Exception {
    ...
    Unmarshaller unmarshaller = JAXBContext.newInstance("io.github.maybee.lexeme.mergeschema").createUnmarshaller();
