package com.github.maybee.lexeme.common.util;
...
public class JDom2Util {
     ...
     *            path
     * @return Document
     * @author sholzer (12.05.2015)
     * @throws IOException
     *             when the file is not found
     * @throws JDOMException
     *             when something unexpected happens while parsing
     ...
     * @param patch
     *            {@link Element}
     * @return {@link List}&lt;{@link Element} with unique element tags (tags from different namespaces are
     *         considered different). The elements are ordered as in the input elements
     ...
     * @param patch
     *            {@link Attribute}
     * @return {@link List}&lt;{@link Attribute} with unique attribute names (names from different namespaces
     *         are considered different). The attributes are ordered as in the input elements
     ...
     * @param base
     *            not null root of the base document
     * @param patch
     ...
     * @param base
     *            base documents root, not null
     * @param patch
     *            patch documents root, not null
     * @param conflictHandling
     *            decides which values will be preferred in case of different locations in base and patch
     ...
     * @param root
     *            root element of xml tree. Replacement will occur on ./descendant-or-self::*
     * @param toReplace
     *            the namespace currently in the document
     * @param replacement
     *            the namespace that should replace toReplace
