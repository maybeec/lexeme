...
public class AttributeMergerImplTest {
  ...
  /**
   * Test method for
   * {@link com.github.maybeec.lexeme.merge.attribute.AttributeMergerImpl#merge(java.lang.String, java.lang.String, ConflictHandlingType)}
   * <p>
  ...
  public void testMergeAttachLastWithoutString() {
    ...
    assertTrue("Expected " + value1 + value2 + " but returned " + mergedValue, mergedValue.equals(value1 + value2));
  }
  ...
  public void testMergeAttachFirstWithoutString() {
    ...
    String mergedValue = test.merge(value1, value2, ConflictHandlingType.PATCHATTACHOROVERWRITE);
    assertTrue("Expected " + value2 + value1 + " but returned " + mergedValue, mergedValue.equals(value2 + value1));
  }
  ...
  public void testMergeRankedBothInList() {/*
                                            ...
                                            * testConfiguration.setType(AttributeType.RANKED); String value1 = "abc";
                                            * String value2 = "def"; String value3 = "ghi";
                                            *
                                            * String ranked = value1 + ";" + value2 + ";" + value3;
                                            * testConfiguration.setContent(ranked);
                                            *
                                            * AttributeMergerImpl test = new AttributeMergerImpl(testConfiguration);
                                            * String result = test.merge(value2, value3);
                                            *
  ...
  public void testMergeRankedOneInList() {/*
                                           ...
                                           *
                                           * AttributeMergerImpl test = new AttributeMergerImpl(testConfiguration);
                                           * String result = test.merge("jkl", value3);
                                           *
   ...
   * {@link com.github.maybeec.lexeme.merge.attribute.AttributeMergerImpl#merge(java.lang.String, java.lang.String, ConflictHandlingType)}
   * <p>
   * Tests the Ranked configuration with no parameters contained in the ranked list. Expect fall back to default
   * use-first
   */
  public void testMergeRankedNotInList() {/*
                                           ...
                                           *
                                           * AttributeMergerImpl test = new AttributeMergerImpl(testConfiguration);
                                           * String result = test.merge(value4, value5);
                                           *
