...
import io.github.maybee.lexeme.common.exception.UnmatchingNamespacesException;
...
import io.github.maybee.lexeme.merge.element.ElementMergerBuilder;
...
public class XMLMergerTest {
    ...
    public void testMergeUnmatchingNamespaces() throws Exception {
        Element element1 = new Element("root", "io.github.maybee.lexeme");
        Element element2 = new Element("root", "io.github.maybee.lexeme.mergeschema");
