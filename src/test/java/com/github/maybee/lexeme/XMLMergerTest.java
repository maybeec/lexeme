...
import com.github.maybee.lexeme.merge.element.ElementMergerBuilder;
...
public class XMLMergerTest {
    ...
    public void testMergeUnmatchingNamespaces() throws Exception {
        Element element1 = new Element("root", "com.github.maybee.lexeme");
        Element element2 = new Element("root", "com.github.maybee.lexeme.mergeschema");
