...
public interface ElementComparator {
   ...
   *
   * @param firstElement {@link Element} first element
   * @param secondElement {@link Element} second element
   * @return boolean true if they're considered mergeable, false otherwise
   * @throws ElementsCantBeMergedException when an Exception occurs
   */
