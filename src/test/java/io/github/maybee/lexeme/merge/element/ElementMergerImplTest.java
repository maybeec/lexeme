...
import io.github.maybee.lexeme.merge.element.ElementMerger;
import io.github.maybee.lexeme.merge.element.ElementMergerFactory;
import io.github.maybee.lexeme.merge.element.ElementMergerImpl;
...
import io.github.maybee.lexeme.mergeschema.Content;
...
public class ElementMergerImplTest {
    ...
    public void testDefaultExtendedOtherNamespace() throws Exception {
        ...
        when(genericComparator.compare(Matchers.any(Element.class), Matchers.any(Element.class))).thenReturn(
            false); // prevents the match of the <ns:b/> elements
